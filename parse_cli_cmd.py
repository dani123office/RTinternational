...
import re
# Look for generateCodeAndExecute command registration in commander
lines = content.splitlines()
for i, line in enumerate(lines):
    if "generateCodeAndExecute" in line and ".command" in line:
        print(f"--- Command registration at line {i} ---")
