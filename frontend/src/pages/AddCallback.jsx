...
export default function AddCallback() {
  ...
  useEffect(() => {
    ...
    setForm((p) => ({
      ...
      accountNumber: callbackData.linkedTransferAccountNumber || '',
      mpan: callbackData.linkedTransferMpan || '',
      mprn: callbackData.linkedTransferMprn || '',
      msn: callbackData.linkedTransferMsn || '',
